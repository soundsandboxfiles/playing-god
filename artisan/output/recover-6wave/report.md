...
- **Scored SSE:** 33.290  (lower is better; 0 = a perfect, sample-identical match)
- **Similarity (1/SSE):** 0.030039
- **Silence floor for this target:** 4583.688 — a silent render scores this. This render is **137.690× better than silence**.
- **MIMIC's best on this target:** 130.920 — ARTISAN is **3.933× better**.
