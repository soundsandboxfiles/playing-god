...
- **Scored SSE:** 1935.202  (lower is better; 0 = a perfect, sample-identical match)
- **Similarity (1/SSE):** 5.1674e-4
- **Silence floor for this target:** 7975.962 — a silent render scores this. This render is **4.122× better than silence**.
- **MIMIC's best on this target:** 7943.730 — ARTISAN is **4.105× better**.
