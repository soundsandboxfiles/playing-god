...
- **Scored SSE:** 38.740  (lower is better; 0 = a perfect, sample-identical match)
- **Similarity (1/SSE):** 0.025813
- **Silence floor for this target:** 4583.688 — a silent render scores this. This render is **118.320× better than silence**.
- **MIMIC's best on this target:** 130.920 — ARTISAN is **3.379× better**.
...
- **Wall-clock time:** 151.3 s.
- **Random seed:** 2 (reproducible).
